...
class LlavaLlamaForCausalLM(LlamaForCausalLM, LlavaMetaForCausalLM):
    ...
    def forward(
        ...
        # print('In LlavaLlamaForCausalLM forward')
        # print('Input ids', input_ids)
        # print('Input embeds', inputs_embeds)

        # TODO here change this
        # assert (images is not None) or (inputs_embeds is not None), "LlavaLlamaForCausalLM forward pass requires images"
    ...
    def generate(
        ...
        **kwargs,
        ...
        # print('In LlavaLlamaForCausalLM generate')
        # print(inputs.shape if inputs is not None else "inputs is None")

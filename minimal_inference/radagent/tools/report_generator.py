...
class ReportGenerationTool:
    def __init__(self):
        ...
        # model_path = "/capstor/store/cscs/swissai/a135/wp3-agents/workspace/3dragent-agent-mel/radagent/toolbox_src/CT_CHAT_main/1702-f1class-f1llm_20260217_161654/checkpoint-198"
        # self.model.model = PeftModel.from_pretrained(
        #     self.model.model, model_path, local_files_only=True
        # )

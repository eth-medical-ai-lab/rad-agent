...
if __name__ == "__main__":
    # input_file = "/capstor/store/cscs/swissai/a135/wp3-agents/workspace/CT-RATE/dataset/train_fixed/dataset/train_fixed/train_328/train_328_a/train_328_a_1.nii.gz"
    # window = "lung"
    # windowing_tool_result = windowing_fn(input_file, window)
    # print(windowing_tool_result)
